...
angular.module("templates/rcalendar/monthviewEventDetail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/rcalendar/monthviewEventDetail.html",
    "<ion-content class=\"event-detail-container backgrnd\" has-bouncing=\"false\" ng-show=\"showEventDetail\" overflow-scroll=\"false\">\n" +
   
    
    "           <div class=\"list card\" ng-repeat=\"event in selectedDate.events\" ng-click=\"eventSelected({event:event})\">\n" +
    "                  <div class=\"item item-divider cardhead\">\n" +
    "                    <h2 class=\"hclr\">  {{::event.startTime|date: 'HH:mm'}} \n" +
    "                         -\n" +               
    "                       {{::event.endTime|date: 'HH:mm'}}</h2>\n" +
    "                   </div>\n" +
    "                     <div class=\"item item-body bodyhgt\" ui-sref=\"ViewEvents\" ng-style=\"{height: '84px'}\"\n" +
    "                      >\n " +
    "                        <div class=\"item-avatar testCss\" ng-style=\"{}\"\n" +
    "                      >\n " +
    "                          <img src=\"img/Upcoming-Events-Icon.png\"> </i>\n" +
    "                           <h2 class=\"contnt\">{{::event.title}} </h2>\n" +
    ...
    "        <div ng-if=\"!selectedDate.events\">\n" +
     // "             <center><img class=\"imgclr\" src=\"img/no_events.png\"> </center>\n" +
    "            <h3 class=\"no-event-label fontcs\" ng-bind=\"::noEventsLabel\"></h3>\n" +
